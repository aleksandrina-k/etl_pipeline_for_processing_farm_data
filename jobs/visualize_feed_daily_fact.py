...
if __name__ == "__main__":
    ...
    source_table_location = r"../spark-warehouse/gold/feed_daily_fact"

    job = VisualizeFeed(
        source_table_location,
        farm_table_location,
        output_container_id="feed_output_container",
        mapped_id="feed_daily_fact_map",
        date_picker_id="date_picker",
        farm_picker_id="farm_picker",
        kpi_picker_id="feed_kpi_picker",
        kpi_list=FEED_KPIS,
